...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (toc) {
    ...
    backBtn.innerHTML = '<br><hr style="border-color: rgba(255,255,255,0.2);"><a href="index.html" class="text-light text-decoration-none d-inline-block mt-2" style="font-size: 1.1rem; transition: opacity 0.2s; opacity: 0.8;" onmouseover="this.style.opacity=\\'1\\'" onmouseout="this.style.opacity=\\'0.8\\'"><i class="bi bi-arrow-left"></i> Portfolio</a>';
