...
![](portada_articulo_nueva.jpg){style="width: 100%; border-radius: 8px; margin-bottom: 2rem;"}
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (sidebar) {
    ...
    btn.innerHTML = `<a href="index.html" class="text-light text-decoration-none d-inline-block" style="font-size: 1.1rem; opacity: 0.8; transition: opacity 0.2s;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.8'"><i class="bi bi-arrow-left"></i> Portfolio</a>`;
