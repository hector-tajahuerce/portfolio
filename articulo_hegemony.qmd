...
<a href="index.html" class="text-light text-decoration-none d-inline-block mb-4" style="font-size: 1.1rem; transition: opacity 0.2s; opacity: 0.8;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.8'">
  <i class="bi bi-arrow-left"></i> Volver al portfolio
</a>
